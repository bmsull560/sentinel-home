...
## Codebase Intelligence for sentinel-home (Repowise)

Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-07-12 (commit d68e9ae)
...
### Code health
Three co-equal signals: defect risk 9.43/10 avg, hotspot health 9.43/10 (stable), worst `server/intelligence/ingestionPipeline.ts` at 6.74/10 · maintainability 9.48/10 · performance risk 9 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
