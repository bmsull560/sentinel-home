          ...
          {PLANS.map(plan => {
            ...
            return (
              ...
              >
                <div className="mb-4">
                  <div
                    className={`text-xs font-semibold uppercase tracking-wider mb-1 ${plan.highlighted ? "text-white/60" : "text-black/40"}`}
                  >
                    {plan.name}
                  </div>
                  <div className="flex items-baseline gap-1">
                    ...
                    {plan.period && (
                      <span
                        className={`text-xs ${plan.highlighted ? "text-white/50" : "text-black/40"}`}
                      >
                        {plan.period}
                      </span>
                    )}
        ...
        <div className="rounded-2xl border border-dashed border-black/10 p-5 flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-black/40 leading-relaxed">
              All billing is handled securely through Stripe. Your payment
              information is never stored on our servers. Cancel or change plans
