...
const PLANS = [
  ...
  },
  {
    ...
    seats: 50,
    features: [
      "250 monitored devices",
      "50 team seats",
      "Agent Console",
      "NVD/CISA integration",
      "Priority support",
    ],
  },
  {
    ...
    <div className="min-h-screen bg-white text-black font-sans">
      ...
      <header className="sticky top-0 z-50 bg-white/90 backdrop-blur border-b border-black/5">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-black/60">
            ...
            <a href="#agents" className="hover:text-black transition-colors">
              Agents
            </a>
          </nav>
      ...
      <section className="max-w-6xl mx-auto px-6 pt-24 pb-20 text-center">
        ...
        <h1 className="text-5xl md:text-7xl font-bold tracking-tight leading-none mb-6">
          The Credit Karma
          <br />
          <span style={{ color: "oklch(0.55 0.12 250)" }}>
            of cybersecurity
          </span>
          <br />
          for your devices.
        ...
        <p className="text-lg md:text-xl text-black/50 max-w-2xl mx-auto mb-10 leading-relaxed">
          Sentinel monitors every connected device in your home or organization,
          translates complex vulnerabilities into plain language, and guides you
          to safety — calmly, clearly, and without alarm.
        </p>
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <a href={isAuthenticated ? "/dashboard" : getLoginUrl()}>
            <Button
              size="lg"
              className="bg-black text-white hover:bg-black/80 rounded-2xl px-8 h-12 text-base font-semibold"
            >
          ...
          <a href="#features">
            <Button
              size="lg"
              variant="outline"
              className="rounded-2xl px-8 h-12 text-base font-semibold border-black/15 hover:bg-black/5"
            >
              See how it works
            </Button>
          </a>
        ...
        <div className="mt-16 relative">
          <div className="rounded-3xl border border-black/10 overflow-hidden shadow-2xl shadow-black/5 bg-white">
            <div className="bg-black/5 px-6 py-3 flex items-center gap-2 border-b border-black/5">
              ...
              <div className="flex-1 text-center text-xs text-black/40 font-mono">
            ...
            <div className="p-8 grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                ...
                <div
                  ...
                  style={{
                    background: "oklab(0.7 0.0260473 -0.147721 / 0.07)",
                  }}
                >
                  <div className="text-xs text-black/50 font-medium mb-2">
                    {label}
                  </div>
      ...
      <section id="features" className="max-w-6xl mx-auto px-6 py-20">
        <div className="text-center mb-14">
          ...
          <p className="text-black/50 text-lg max-w-xl mx-auto">
            Built for consumers and enterprise teams alike — powerful
            intelligence, zero complexity.
          </p>
        </div>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
          {FEATURES.map(({ icon: Icon, title, desc }) => (
            <div
              key={title}
              className="rounded-2xl p-6 border border-black/8 hover:border-black/15 transition-colors"
            >
              <div
      ...
      <section
        id="agents"
        className="max-w-6xl mx-auto px-6 py-20 border-t border-black/5"
      >
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-5">
              Six agents. One calm experience.
            </h2>
            <p className="text-black/50 leading-relaxed mb-8">
              Behind every vulnerability explanation is a coordinated team of AI
              agents — each with a specific role, working together to give you
              accurate, safe, and actionable guidance.
            </p>
              ...
              {[
                {
                  name: "The Guide",
                  role: "Orchestrator",
                  desc: "Coordinates all agents, maintains context",
                },
                {
                  name: "The Mapper",
                  role: "Device Intelligence",
                  desc: "Maps devices to CVEs and firmware alerts",
                },
                {
                  name: "The Explainer",
                  role: "Security Expert",
                  desc: "Safe, responsible technical explanations",
                },
                {
                  name: "The Sculptor",
                  role: "UX Architect",
                  desc: "Converts intelligence into visual structures",
                },
                {
                  name: "The Narrator",
                  role: "Storytelling",
                  desc: "Human-readable summaries and gentle nudges",
                },
                {
                  name: "The Guardian",
                  role: "Ethics & Safety",
                  desc: "Removes alarmism, ensures privacy",
                },
              ].map(({ name, role, desc }) => (
          ...
          >
            {[
              ...
              },
              {
                step: "02",
                agent: "Mapper",
                action: "Identifying CVE-2024-1234 on Ring Doorbell Pro 2…",
              },
              {
                step: "03",
                agent: "Explainer",
                action: "Generating safe explanation…",
              },
              {
                step: "04",
                agent: "Sculptor",
                action: "Building Risk Card UI…",
              },
              {
                step: "05",
                agent: "Narrator",
                action: "Composing gentle notification…",
              },
              {
                step: "06",
                agent: "Guardian",
                action: "Safety pass complete ✓",
              },
            ].map(({ step, agent, action }) => (
              <div
                key={step}
                className="flex items-center gap-3 bg-white rounded-xl px-4 py-3 border border-black/5"
              >
                <span className="text-xs font-mono text-black/30 w-6 shrink-0">
                  {step}
                </span>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
          {PLANS.map(({ name, price, period, features, highlight }) => (
            ...
            >
              <div className="mb-5">
                <div
                  className={`text-xs font-semibold uppercase tracking-widest mb-3 ${highlight ? "text-white/60" : "text-black/40"}`}
                >
                  {name}
                </div>
                <div className="flex items-baseline gap-1">
                  ...
                  <span
                    className={`text-sm ${highlight ? "text-white/50" : "text-black/40"}`}
                  >
                    /{period}
                  </span>
                </div>
              ...
              <ul className="space-y-2 mb-6">
                {features.map(f => (
                  <li key={f} className="flex items-center gap-2 text-sm">
                    ...
                    />
                    <span
                      className={highlight ? "text-white/80" : "text-black/70"}
                    >
                      {f}
                    </span>
                  </li>
      ...
      <footer className="border-t border-black/5 py-12">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="text-xs text-black/40">
            © 2026 Sentinel Home. The Credit Karma of cybersecurity for your
            devices.
          </div>
