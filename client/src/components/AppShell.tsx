  ...
  const Sidebar = () => (
    <aside className="flex flex-col h-full w-64 border-r border-border bg-card">
      ...
      <nav className="flex-1 px-3 pt-4 space-y-0.5 overflow-y-auto">
        <div className="text-xs font-semibold text-muted-foreground px-3 pb-2 uppercase tracking-widest">
          Workspace
        </div>
        ...
        <div className="text-xs font-semibold text-muted-foreground px-3 pt-5 pb-2 uppercase tracking-widest">
          Organization
        </div>
